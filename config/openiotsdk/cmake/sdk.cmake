...
if(TFM_SUPPORT)
    ...
    set(TFM_CMAKE_ARGS "-DCONFIG_TFM_ENABLE_FP=ON;-DTFM_PROFILE=profile_medium;-DTFM_EXCEPTION_INFO_DUMP=ON;-DCONFIG_TFM_HALT_ON_CORE_PANIC=ON;-DTFM_MBEDCRYPTO_PLATFORM_EXTRA_CONFIG_PATH=${OPEN_IOT_SDK_CONFIG}/mbedtls/mbedtls_config_psa.h")
    set(TFM_CMAKE_ARGS "${TFM_CMAKE_ARGS};-DTFM_ISOLATION_LEVEL=1")
...
if(TARGET lwip-cmsis-port)
    ...
    target_compile_definitions(lwipopts
        INTERFACE
            ...
            $<$<BOOL:${CONFIG_CHIP_BUILD_TESTS}>:CHIP_LIB_TESTS>
    )
