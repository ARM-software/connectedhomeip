...
int main()
{
    ...
    {
        ChipLogError(Shell, "Corstone platform initialization failed");
        return EXIT_FAILURE;
    }

    ChipLogProgress(Shell, "Corstone shell example application start");
    ...
    {
        ChipLogError(Shell, "Corstone CHIP stack initialization failed");
        return EXIT_FAILURE;
    }
    ...
    ChipLogProgress(Shell, "Corstone shell example application run");
