...
int main()
{
    ChipLogProgress(NotSpecified, "Corstone ota-requestor-app example application start");
    ...
    ChipLogProgress(NotSpecified, "Corstone ota-requestor-app example application run");
