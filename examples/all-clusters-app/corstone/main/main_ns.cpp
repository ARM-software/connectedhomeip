...
int main()
{
    ...
    ChipLogProgress(NotSpecified, "Corstone all-clusters-app example application start");
    ...
    ChipLogProgress(NotSpecified, "Corstone all-clusters-app example application run");
