# Matter Corstone All-Clusters-App Example Application

The Corstone All Clusters Example demonstrates various ZCL clusters control.
...
```
[INF] [-] Corstone all-clusters-app example application start
...
[INF] [-] Corstone all-clusters-app example application run
```
