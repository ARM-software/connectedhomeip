...
#include <platform/corstone/CorstoneArchUtils.h>
#include <platform/corstone/Logging.h>
...
#ifdef CHIP_CORSTONE_OTA_ENABLE
#include "corstone_dfu_manager.h"
#endif // CHIP_CORSTONE_OTA_ENABLE
