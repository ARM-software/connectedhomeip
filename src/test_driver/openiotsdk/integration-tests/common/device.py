...
class Device:
    ...
    async def send(self, command, expected_output=None, wait_before_read=None, wait_for_response=30, assert_output=True, suffix='\n'):
        """
    ...
    async def wait_for_output(self, search: str, timeout: float = 30, assert_timeout: bool = True, verbose: bool = False) -> [str]:
        """
