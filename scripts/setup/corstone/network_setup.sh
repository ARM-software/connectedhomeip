...
# Enable/disable/restart Corstone networking environment.
...
Enable, disable or restart Corstone networking environment.

Options:
    -h,--help                           Show this help
    -n,--name    <base_name>            Corstone network base name <base_name - default is ARM>
